...
public class InventoryView extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mItemImage = (ImageView) findViewById(R.id.item_img);
        ...
        mReceiveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (newStockToAdd.isEmpty()) {
                    Toast.makeText(InventoryView.this, "Enter a quantity", Toast.LENGTH_SHORT).show();
                    return;
                } else {
            ...
            public void onClick(View view) {
                ...
                if (stockToSell.isEmpty()) {
                    ...
                    if (newQty >= 0) {
                        ...
                        Toast.makeText(InventoryView.this, "This product doesn't exist!", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.edit_item:
                Intent intent = new Intent( InventoryView.this, EditorActivity.class );
                intent.setData(mCurrentItemUri);
                startActivity(intent);
                return true;
            case R.id.resupply_item:
                itemResupply(new String[]{"itemsupply@yahoo.com"}, " Product Resupply: ");
                return true;
        }
