...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private void saveItem() {
        ...
        if (mCurrentItemUri == null && TextUtils.isEmpty(nameString) && TextUtils.isEmpty(descString) && TextUtils.isEmpty(priceString) && TextUtils.isEmpty(stockString)) {
            return;
        }
    ...
    private void showUnsavedChangesDialog(DialogInterface.OnClickListener discardButtonClickListener) {
        ...
        builder.setNegativeButton("Editing", new DialogInterface.OnClickListener() {
            @Override
